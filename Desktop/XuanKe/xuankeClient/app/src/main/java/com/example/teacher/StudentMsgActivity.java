...
//学生个人中心界面
public class StudentMsgActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_sex:
                mMaterialDialog = new AlertDialog.Builder(StudentMsgActivity.this);
                mMaterialDialog.setTitle("修改性别");
                NumberPicker picker = new NumberPicker(StudentMsgActivity.this);
                ...
                break;
            case R.id.rl_name:
                contentView = new EditText(StudentMsgActivity.this);
                contentView.setGravity(Gravity.CENTER);

                mMaterialDialog = new AlertDialog.Builder(StudentMsgActivity.this)
                        .setTitle("修改名字").setView(contentView);
                mMaterialDialog.setPositiveButton("确定",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (nickname.length() > 10 || nickname.length() < 2) {
                                    Toast.makeText(StudentMsgActivity.this,
                                            "名字的长度为3~10之间", Toast.LENGTH_SHORT)
                                            .show();
                                    return;
                                } else {
            ...
            case R.id.rl_pswd:
                Intent i2 = new Intent(StudentMsgActivity.this,
