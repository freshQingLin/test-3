...
//已选课学生界面
public class ApplyListActivityForTeacher2 extends BaseActivity {
    ListView lv;
    JSONArray array;
    int cid;
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (statu == 1) {
                    ...
                    new AlertDialog.Builder(ApplyListActivityForTeacher2.this)
                            .setTitle("选项")
                            .setItems(new String[]{"同意申请", "拒绝申请"},
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog,
                                            ...
                                            switch (which) {
                                                case 0:
                                                    update(object.optInt("aid"), 3);
                                                    break;

                                                case 1:


                                                    contentView = new EditText(ApplyListActivityForTeacher2.this);
                                                    contentView.setGravity(Gravity.CENTER);

                                                    mMaterialDialog = new AlertDialog.Builder(ApplyListActivityForTeacher2.this)
                                                    ...
                                                    mMaterialDialog.setPositiveButton("确定",
                                                            new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    if (content.equals("")) {
                                                                        Toast.makeText(ApplyListActivityForTeacher2.this,
                                                                                "理由不能为空", Toast.LENGTH_SHORT)
                                                                                .show();
                                                                    } else {
                                                                        HttpParams params = new HttpParams();
                                                                        params.put("aid", aid);
                                                                        params.put("content3", content);
                                                                        Api.post("updateApply2", params, new Api.CallBack() {
                                                                            @Override
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextView tView = new TextView(ApplyListActivityForTeacher2.this);
